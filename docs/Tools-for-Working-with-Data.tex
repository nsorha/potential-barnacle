...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ park <-}\StringTok{ }\NormalTok{park }\OperatorTok{%>%}
\StringTok{   }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Anthropomorphismf =}\KeywordTok{recode}\NormalTok{(Anthropomorphism, }\StringTok{`}\DataTypeTok{0}\StringTok{`}\NormalTok{ =}\StringTok{ "Nonanthropomorphic"}\NormalTok{, }\StringTok{`}\DataTypeTok{1}\StringTok{`}\NormalTok{ =}\StringTok{ "Anthropomorphism"}\NormalTok{))}
 
\NormalTok{park <-}\StringTok{ }\NormalTok{park }\OperatorTok{%>%}
\StringTok{   }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{TheoryofIntelligencef =}\KeywordTok{recode}\NormalTok{(TheoryofIntelligence, }\StringTok{`}\DataTypeTok{0}\StringTok{`}\NormalTok{ =}\StringTok{ "Incremental"}\NormalTok{, }\StringTok{`}\DataTypeTok{1}\StringTok{`}\NormalTok{ =}\StringTok{ "Entity"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{describeBy}\NormalTok{(park}\OperatorTok{$}\NormalTok{Total_NumberofHelp,}\KeywordTok{list}\NormalTok{(park}\OperatorTok{$}\NormalTok{Anthropomorphismf,park}\OperatorTok{$}\NormalTok{TheoryofIntelligencef))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Tools-for-Working-with-Data_files/figure-latex/unnamed-chunk-92-1.pdf}
...
\includegraphics{Tools-for-Working-with-Data_files/figure-latex/unnamed-chunk-93-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{parkent <-}\StringTok{ }\NormalTok{park }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(TheoryofIntelligence }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{parkinc <-}\StringTok{ }\NormalTok{park }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(TheoryofIntelligence }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
